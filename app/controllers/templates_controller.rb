  ...
  def create
    ...
    if @template.save
      respond_to do |format|
        format.html { redirect_to staff_date_path(@staff_date), notice: "Template was successfully create." }
        format.turbo_stream { flash.now[:notice] = "Template was successfully create." }
      end
    else
